========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : DBTool
========================================================================


AppWizard が生成した DBTool には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには DBTool を構成している各ファイルの概要説明が含まれています。
...
DBTool.h
    ...
    みます） をインクルードし、また CDBToolApp アプリケーションクラスを宣
    言します。

DBTool.cpp
    このファイルは CDBToolApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\DBTool.ico
    ...
    ルです。このアイコンはリソース ファイル DBTool.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、DBTool.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

DBToolDoc.h, DBToolDoc.cpp - ドキュメント
    これらのファイルは CDBToolDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CDBToolDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

DBToolView.h, DBToolView.cpp - ビュー
    これらのファイルは CDBToolView クラスを含みます。
    CDBToolView オブジェクトは CDBToolDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) DBTool.pch 
