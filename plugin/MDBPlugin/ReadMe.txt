========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MDBPlugin
========================================================================


AppWizard が生成した MDBPlugin には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには MDBPlugin を構成している各ファイルの概要説明が含まれています。
...
MDBPlugin.h
	...
	CMDBPluginApp アプリケーションクラスを宣言します。

MDBPlugin.cpp
	このファイルは CMDBPluginApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MDBPlugin.pch 
